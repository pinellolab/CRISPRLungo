...
def LD_tornado():
    ...
    LD_list =[]
    for i in range(150):
        a = 2300 - random.randint(0,50)
        rand_st = a
        if a > 2200:
            rand_st = 2300
        l = random.randint(0, 1700)
        LD_list.append([a, a+l, l])
        
    for i in range(150):
        a = random.randint(0,2300)
        l = 2300 - a + random.randint(0, 50)
        LD_list.append([a, a+l, l])
    ...
    for i in range(100):
        ...
        if a > 2200:
            rand_st = 2300
        l = random.randint(rand_st, 4000)
        if a < 2300 < a + l and a+l < 3500:
            LD_list.append([a, a+l, l])
    ...
    #ax.annotate('', xy=(-5, 1.55), xytext=(2.5, 1.55), arrowprops=dict(arrowstyle='-'))
    #ax.annotate('', xy=(-2, 1.5), xytext=(5.5, 1.5), arrowprops=dict(arrowstyle='-', linewidth=1, color='r'))
    #ax.annotate('', xy=(-3, 1.45), xytext=(5, 1.45), arrowprops=dict(arrowstyle='-', linewidth=1, color='r'))
