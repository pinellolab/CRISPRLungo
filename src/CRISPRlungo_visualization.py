...
CITATION_HTML = """
<div class="container container-narrow" style="max-width:980px;margin:32px auto 24px;">
  <div style="padding:16px 20px;border:1px solid #e5e7eb;border-radius:10px;
              background:#f8f9fa;font-size:14px;line-height:1.65;color:#111827;">
    <b>If you use CRISPRLungo, please support us by citing it in your work:</b><br>
    Hwang GH, Vyshedskiy B, Barry T, Zeng J, Levesque S, Manis JP, Shimamura A,
    Bauer DE, Pinello L.<br>
  ...
  <div style="margin-top:10px;font-size:13px;color:#6b7280;">
    ...
    <a href="https://github.com/pinellolab/CRISPRLungo">GitHub</a> &middot;
    <a href="https://github.com/pinellolab/CRISPRLungo/issues">Report an issue</a>
  </div>
</div>
"""
...
def write_html(plots, control_check, target_check, output_dir, mut_cnt, precise_cnt, edited_reads_cnt):
	...
	full_html += '</div></div>' + CITATION_HTML + '<link href="css/bootstrap-5.3.7-dist/css/bootstrap.min.css" rel="stylesheet"><script src="css/bootstrap-5.3.7-dist/js/bootstrap.bundle.min.js"></script></body></html>'
